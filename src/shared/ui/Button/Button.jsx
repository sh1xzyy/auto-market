...
export const Button = ({
  ...
  const variants = {
    primary: `h-[36px] text-light-white bg-light-orange rounded-md ${transitionStyles} hover:bg-dark-orange`,
    ...
    text: `py-4 text-light-orange underline w-full m-auto ${transitionStyles} hover:text-dark-orange`,
  };
